...
import com.example.uipj.adapter.card.CardLeanAdapter
import com.example.uipj.data.dao.CardDAO
import com.example.uipj.data.model.Card
import com.example.uipj.databinding.ActivityLearnBinding
...
class LearnActivity : AppCompatActivity(), CardStackListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(com.example.uipj.R.menu.menu_tick, menu)
        return true
    }

    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == com.example.uipj.R.id.done) {
            showHide()
        }
